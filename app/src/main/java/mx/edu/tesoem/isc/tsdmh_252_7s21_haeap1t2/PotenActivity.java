...
public class PotenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poten);
    ...
    public  void onclickpoten (View v){
        ...
        String cadena = "El resultado del numero " +num1+ "\nUsando como exponente " +num2+ "\nEs :" + res;
